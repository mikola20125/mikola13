var works = {
    ...
    'Домой Вы приходите только к обеду, но у Вас еще есть дела и Вы ...\n',
    c0: 2,
    c1: '1 - Обедать\n',
    c2: '2 - Поколоть дров перед обедом\n',
    d00:'Вы решили пообедать и после обеда Вы займетесь',
    /*'Потом пишем несколько действий, например, два\n',*/
    d0: 2, // кол-во ответов
    d1: '1 - Поколоть дрова\n',
    d2: '2 - Спортзал\n',
    e00:'Поколоть дров. Топор с трудом стал колоть дрова и Вы\n',
    e0: 2,
    e1:'1 - посетить спортзал чтобы поддержать форму\n',
    e2:'2 - пойти подточить топор',
    f00:'Вы решили посетить спортзал\n'+
        'Продолжение следует...'
